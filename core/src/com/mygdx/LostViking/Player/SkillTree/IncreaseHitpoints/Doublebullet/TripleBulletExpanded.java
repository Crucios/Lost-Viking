package com.mygdx.LostViking.Player.SkillTree.IncreaseHitpoints.Doublebullet;
...
public class TripleBulletExpanded extends Node{
	...
	public void update(float dt) {
		...
		if(bulletTimer > 0.5f) {
			...
			bullet.add(new BaseBullet(world,new Vector2(bulletPosition.x + 0.2f, bulletPosition.y),-15, true,player));
			bullet.add(new BaseBullet(world,new Vector2(bulletPosition.x - 0.2f, bulletPosition.y),15, true,player));
		bulletTimer = 0;
		}
	}
